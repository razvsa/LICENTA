        ...
        <div class="col">
            ...
            <div class="card-footer bg-transparent">
                <ul class="d-flex flex-wrap justify-content-between">
                    ...
                    <li><?=\yii\helpers\Html::a('Editeaza',['anunt/update','id'=>$model->id],['class'=>'btn btn-outline-info'])?></li>
                    <li><?= \yii\helpers\Html::a('Sterge anunt', ['anunt/sterge-anunt', 'id' => $model->id], [

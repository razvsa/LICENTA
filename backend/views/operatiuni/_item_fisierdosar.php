    ...
    <div class="p">
        <div class="card-body">
            ...
            <ul class="d-flex justify-content-between">
                <li><?=\yii\helpers\Html::a('Editează',['/operatiuni/actualizeaza-fisier-dosar','id'=>$model->id],['class'=>'btn btn-outline-info',])?></li>
                <li><?=\yii\helpers\Html::a('Șterge',['/operatiuni/delete-fisier-dosar','id'=>$model->id],['class'=>'btn btn-outline-danger','data' => [

    ...
    <div class="p">
        <div class="card-body">
            ...
            <ul class="d-flex justify-content-between">
                <li><?=\yii\helpers\Html::a('Editeaza',['/operatiuni/actualizeaza-categorie','id'=>$model->id],['class'=>'btn btn-outline-info',])?></li>
                <li><?=\yii\helpers\Html::a('Sterge',['/operatiuni/delete-categorie','id'=>$model->id],['class'=>'btn btn-outline-danger','data' => [
